...
async def feature_callback(client: Client, callback_query: CallbackQuery):
    ...
    k = f"""**✨ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ {app.mention} ✨

━━━━━━━━━━━━━━━━━━━━━━
🎧 ᴛʜᴇ ᴘᴏᴡᴇʀғᴜʟ ᴍᴜsɪᴄ ʙᴏᴛ ⚡
🚫 ɴᴏ ʟᴀɢ • 🔊 ʜᴅ ᴀᴜᴅɪᴏ • ❌ ɴᴏ ᴘʀᴏᴍᴏ
🕐 𝟐𝟒/𝟕 ᴀᴄᴛɪᴠᴇ | 🏆 ᴜʟᴛʀᴀ ᴘᴇʀғᴏʀᴍᴀɴᴄᴇ
━━━━━━━━━━━━━━━━━━━━━━
📚 ʜᴏᴡ ᴛᴏ ᴜsᴇ ᴍᴇ?

🔘 ᴛᴀᴘ ᴛʜᴇ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ
💡 ᴛᴏ ᴇxᴘʟᴏʀᴇ ᴀʟʟ ᴍʏ ғᴇᴀᴛᴜʀᴇs
🎯 ᴄᴏᴍᴍᴀɴᴅs • ᴍᴏᴅᴜʟᴇs • ᴛɪᴘs & ᴍᴏʀᴇ...
━━━━━━━━━━━━━━━━━━━━━━

🔗 sᴛᴀʏ ᴛᴜɴᴇᴅ • 💖 ᴇɴᴊᴏʏ ᴛʜᴇ ᴠɪʙᴇs!**"""
    await callback_query.message.edit_text(
...
async def feature_callback(client: Client, callback_query: CallbackQuery):
    keyboard = [
        ...
        [
            ...
            InlineKeyboardButton(
                text="sᴏᴜʀᴄᴇ",
                url=f"https://github.com/NoxxOP/ShrutiMusic",
            ),
            InlineKeyboardButton(text="ᴀʟʟ", callback_data="settings_back_helper"),
        ],
        [InlineKeyboardButton(text="ʜᴏᴍᴇ", callback_data="go_to_start")],
